...
def get_rhel83_jobs(server):
    #rhel8.3_jobs = server.get_jobs(view_name='Rhel 8.3')
    ...
    #print("RHEL 8.3 jobs >> ", rhel83_jobs)
    print()
...
def main():
    ...
    #rhel85_jobs = migrate_jobs(server, rhel83_jobs)
    #disable83_jobs(server, rhel83_jobs, rhel85_jobs)
